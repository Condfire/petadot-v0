        ...
        <Card className="border-green-200 bg-green-50">
          ...
          <CardFooter className="flex justify-center">
            <Button variant="outline" className="mt-2" asChild>
              <Link href="/admin-alt/events">Voltar para a lista de eventos</Link>
            </Button>
          </CardFooter>
        </Card>
      </div>
    ...
    <>
      <div className="flex items-center gap-2 mb-6">
        <Button variant="outline" size="icon" asChild>
          <Link href={`/admin-alt/events/${event.id}`}>
        ...
        <Card>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <Button variant="outline" className="w-full" asChild disabled={isDeleting}>
              <Link href={`/admin-alt/events/${event.id}`}>Cancelar</Link>
            </Button>
          </CardFooter>
        </Card>
      </div>
